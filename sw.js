...
const CACHE_VERSION = 'mca-v2026-05-17-v435-vehicules-filtres-option-A-searchbar-large-3btn-uniformes';
...
const CORE_ASSETS = [
  ...
  // Phase X.CL-CO : Edit locks init + Synchro storage listeners + Livraison form init + Modal click
  '/script-core-admin-edit-locks-init.js',
  ...
  '/script-incidents.js',
  '/script-incidents-drawer-360.js',
