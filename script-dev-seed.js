...
(function () {
  ...
  function seed() {
    ...
    // ----- 12 VÉHICULES -----
    const VEHICULES = [
      { id: uid(), immatriculation: 'FG-788-FB', modele: 'OPEL MOVANO L2H2', km: 87500, conso: 10, capaciteReservoir: 80, modeAcquisition: 'occasion', prixAchatHT: 24000, dureeAmortissement: 5, dateAcquisition: '2024-05-18', dateCT: '2026-05-18', dateProchainCT: '2028-05-18', dateFinAssurance: offsetDate(180), entretienIntervalKm: 15000, entretienIntervalMois: 12, tvaCarburantDeductible: 100, statut: 'actif' },
      { id: uid(), immatriculation: 'KH-234-LM', modele: 'RENAULT MASTER 130', km: 145000, conso: 11.5, capaciteReservoir: 100, modeAcquisition: 'lld', loyerMensuelHT: 480, dateAcquisition: '2023-09-01', dateCT: '2025-09-01', dateProchainCT: '2027-09-01', dateFinAssurance: offsetDate(120), entretienIntervalKm: 20000, tvaCarburantDeductible: 100, statut: 'actif' },
      { id: uid(), immatriculation: 'AB-456-CD', modele: 'MERCEDES SPRINTER 314', km: 62000, conso: 9.5, capaciteReservoir: 75, modeAcquisition: 'credit', creditMensualiteHT: 620, dateAcquisition: '2025-01-15', dateCT: '2027-01-15', dateProchainCT: '2029-01-15', dateFinAssurance: offsetDate(220), entretienIntervalKm: 15000, tvaCarburantDeductible: 100, statut: 'actif' },
      { id: uid(), immatriculation: 'XY-789-ZW', modele: 'PEUGEOT BOXER 350', km: 198000, conso: 10.5, capaciteReservoir: 90, modeAcquisition: 'achat', prixAchatHT: 18000, dureeAmortissement: 4, dateAcquisition: '2022-03-10', dateCT: '2024-03-10', dateProchainCT: offsetDate(4), dateFinAssurance: offsetDate(60), entretienIntervalKm: 15000, tvaCarburantDeductible: 100, statut: 'actif' },
      { id: uid(), immatriculation: 'EF-123-GH', modele: 'IVECO DAILY 35S14', km: 34000, conso: 11, capaciteReservoir: 90, modeAcquisition: 'lld', loyerMensuelHT: 510, dateAcquisition: '2025-08-20', dateCT: '2027-08-20', dateProchainCT: '2029-08-20', dateFinAssurance: offsetDate(310), entretienIntervalKm: 20000, tvaCarburantDeductible: 100, statut: 'actif' },
      { id: uid(), immatriculation: 'JK-567-MN', modele: 'CITROEN JUMPER L3H2', km: 112000, conso: 10.8, capaciteReservoir: 90, modeAcquisition: 'occasion', prixAchatHT: 19500, dureeAmortissement: 5, dateAcquisition: '2024-02-12', dateCT: '2026-02-12', dateProchainCT: '2028-02-12', dateFinAssurance: offsetDate(45), entretienIntervalKm: 18000, tvaCarburantDeductible: 100, statut: 'actif' },
      { id: uid(), immatriculation: 'OP-901-QR', modele: 'FORD TRANSIT CUSTOM', km: 28000, conso: 9, capaciteReservoir: 80, modeAcquisition: 'credit', creditMensualiteHT: 560, dateAcquisition: '2025-11-05', dateCT: '2027-11-05', dateProchainCT: '2029-11-05', dateFinAssurance: offsetDate(280), entretienIntervalKm: 15000, tvaCarburantDeductible: 100, statut: 'actif' },
      { id: uid(), immatriculation: 'ST-234-UV', modele: 'VOLKSWAGEN CRAFTER', km: 78000, conso: 10.2, capaciteReservoir: 75, modeAcquisition: 'achat', prixAchatHT: 28000, dureeAmortissement: 6, dateAcquisition: '2023-12-20', dateCT: '2025-12-20', dateProchainCT: '2027-12-20', dateFinAssurance: offsetDate(150), entretienIntervalKm: 20000, tvaCarburantDeductible: 100, statut: 'actif' },
      { id: uid(), immatriculation: 'WX-678-YZ', modele: 'RENAULT TRAFIC', km: 56000, conso: 8.5, capaciteReservoir: 70, modeAcquisition: 'lld', loyerMensuelHT: 410, dateAcquisition: '2024-08-08', dateCT: '2026-08-08', dateProchainCT: '2028-08-08', dateFinAssurance: offsetDate(95), entretienIntervalKm: 15000, tvaCarburantDeductible: 100, statut: 'actif' },
      { id: uid(), immatriculation: 'CD-345-EF', modele: 'FIAT DUCATO L4H2', km: 92000, conso: 11.2, capaciteReservoir: 90, modeAcquisition: 'occasion', prixAchatHT: 21000, dureeAmortissement: 5, dateAcquisition: '2023-06-15', dateCT: '2025-06-15', dateProchainCT: '2027-06-15', dateFinAssurance: offsetDate(180), entretienIntervalKm: 18000, tvaCarburantDeductible: 100, statut: 'actif' },
      { id: uid(), immatriculation: 'GH-789-IJ', modele: 'MAN TGE 5.180', km: 18000, conso: 11.5, capaciteReservoir: 100, modeAcquisition: 'credit', creditMensualiteHT: 720, dateAcquisition: '2026-01-20', dateCT: '2028-01-20', dateProchainCT: '2030-01-20', dateFinAssurance: offsetDate(340), entretienIntervalKm: 25000, tvaCarburantDeductible: 100, statut: 'actif' },
      { id: uid(), immatriculation: 'KL-012-MN', modele: 'RENAULT MASTER (Réserve)', km: 235000, conso: 12, capaciteReservoir: 100, modeAcquisition: 'achat', prixAchatHT: 12000, dureeAmortissement: 8, dateAcquisition: '2020-04-10', dateCT: '2024-04-10', dateProchainCT: '2026-04-10', dateFinAssurance: offsetDate(-30), entretienIntervalKm: 20000, tvaCarburantDeductible: 100, statut: 'reserve' },
    ];
    ...
    // ----- 30 ALERTES ADMIN -----
    const ALERTES = [
      { id: uid(), niveau: 'critical', titre: 'CT véhicule', message: 'CT véhicule ' + VEHICULES[3].immatriculation + ' expire dans 4 jours', type: 'ct', categorie: 'vehicule', meta: { vehId: VEHICULES[3].id }, creeLe: isoDT(new Date()) },
      { id: uid(), niveau: 'critical', titre: 'Assurance', message: 'Assurance véhicule ' + VEHICULES[11].immatriculation + ' expirée', type: 'assurance', categorie: 'vehicule', meta: { vehId: VEHICULES[11].id }, creeLe: isoDT(new Date(Date.now() - 86400000)) },
      ...
      { id: uid(), niveau: 'warn', titre: 'Conso anormale', message: 'Conso anormale Master 130 (' + VEHICULES[1].immatriculation + ') — +18% vs moyenne 30 jours', type: 'conso', categorie: 'carburant', meta: { vehId: VEHICULES[1].id }, creeLe: isoDT(new Date()) },
