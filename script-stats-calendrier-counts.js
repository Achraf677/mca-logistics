...
(function () {
  ...
  function updateCalendrier() {
    ...
    // Phase 91.55 Bug C — Bloc legacy supprimé. Le KPI cal16-kpi-pai est désormais écrit
    // uniquement par cal16 IIFE setKPIMoisCourant() (script.js:9772, Phase 91.50) qui lit
    // strictement paiements[].montant filtré sens:'in' par mois du curseur (pas du mois
    // courant ici). Cette double écriture causait "600€ sans paiement" — livraisons
    // livrées étaient comptées comme encaissées, faux comptablement.
