  ...
  function afficherRentabiliteParChauffeur() {
    ...
    tb.innerHTML = stats.map(function (s) {
      ...
      var warnSal = s.salairManquant
        ? ' <span style="background:rgba(255,214,10,.12);color:var(--ds-warning,#ffd60a);padding:2px 6px;border-radius:8px;font-size:.7rem" title="Aucune charge \'salaires\' avec salId=chauffeur trouvée — coût salaire non comptabilisé">⚠</span>'
        : '';
      return '<tr>' +
