...
(function () {
  ...
  window.exporterEncaissementRapport = function () {
    ...
    var tableRows = rows.map(function (r) {
      var color = r.statut === 'encaisse' ? '#06d6a0' : (r.statut === 'retard' ? '#e63946' : '#ffd60a');
    ...
    var html = entete
      + '<table style="width:100%;border-collapse:collapse;margin-top:14px;font-size:.84rem"><thead><tr style="background:#e6394622"><th style="padding:8px;text-align:left;border-bottom:2px solid #e63946">Date</th><th style="padding:8px;text-align:left;border-bottom:2px solid #e63946">N°</th><th style="padding:8px;text-align:left;border-bottom:2px solid #e63946">Client</th><th style="padding:8px;text-align:right;border-bottom:2px solid #e63946">TTC</th><th style="padding:8px;text-align:left;border-bottom:2px solid #e63946">Statut</th><th style="padding:8px;text-align:left;border-bottom:2px solid #e63946">Date payé</th><th style="padding:8px;text-align:left;border-bottom:2px solid #e63946">Mode</th></tr></thead><tbody>' + tableRows + '</tbody>'
      + '<tfoot><tr style="background:#e6394622;font-weight:700"><td colspan="3" style="padding:8px;border-top:2px solid #e63946">TOTAL</td><td style="padding:8px;text-align:right;border-top:2px solid #e63946">' + totalTtc.toFixed(2).replace('.', ',') + ' €</td><td colspan="3" style="border-top:2px solid #e63946"></td></tr></tfoot></table>';
